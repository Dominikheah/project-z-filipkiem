...
// Dodajemy przykładową treść pod navbarem
const content = document.getElementById('content');
const welcome = document.createElement('p');
welcome.textContent = 'Witaj na stronie naszej lokalnej redakcji! Tutaj znajdziesz najnowsze wiadomości, aktualności i ciekawe artykuły z Twojego miasta.';
